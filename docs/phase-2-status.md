...
- Base de donnees: SQLite solide pour MVP local, schema PostgreSQL pret, healthcheck de transition disponible, lectures/auth et mutations de configuration branchees sur PostgreSQL via flag; il reste les ecritures comptables et imports.
